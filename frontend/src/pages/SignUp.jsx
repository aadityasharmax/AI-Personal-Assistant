...
const SignUp = () => {
  ...
  return (
    ...
    >
      <form className="w-[90%] h-[600px] max-w-[500px] bg-[#00000048] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center px-[20px]"
      ...
      >
        ...
        {err.length > 0 && <p className="text-orange-400 text-lg mb-3">*{err}</p> }

        <button className="min-w-[150px] h-[60px] bg-white rounded-full text-black font-semibold text-[19px] cursor-pointer mb-4"
        disabled={loading}
        >
          {loading ? "Loading..." : "Sign Up"}
        </button>

        <p className="text-white text-18px" onClick={() => navigate("/signin")}>
